    ...
    public class AccountController : Controller
    {
       ...
       public ActionResult EditeProfile()
        ...
        public ActionResult EditeProfile(EditProfileViewModel profile)
        {
            var userid = User.Identity.GetUserId();
            var user = db.Users.Where(a => a.Id == userid).SingleOrDefault();
            if (!UserManager.CheckPassword(user, profile.Password))
            {
                ViewBag.msg = "This password not correct";
            }
            else
            {
                var hash = UserManager.PasswordHasher.HashPassword(profile.NewPassword);
                user.UserName = profile.UserName;
                user.Email = profile.Email;
                user.PasswordHash = hash;
                db.Entry(user).State = System.Data.Entity.EntityState.Modified;
                db.SaveChanges();
                ViewBag.msg = "your profile is Edited";
